...
<tr><td style="font-family:Lucida Calligraphy; font-size:25px; color:#09F; padding-bottom:38px;" class="headingText"><b>Category</b></td></tr>
<?php
...
while($data=mysqli_fetch_array($result))
{
		...
		echo "<tr><td style= ' padding:5px;'><b><a style=' font-size:20px; text-decoration:none;'href='subcat.php?catid=$data[0]'>$data[1]</a></b></td></tr>";
...
<div style="width:800px; float:left">
	...
	<tr><td class="headingText">Welcome to Travelogue INDIA</td></tr>
	<tr><td class="paraText" width="1100px" style= "font-size:16px;">Plan and Book Your Perfect Trip.Create your dream holiday.
